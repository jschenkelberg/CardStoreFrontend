...
class MerchForm extends Component {
   ...
   await  axios.post(
      `https://localhost:44394/api/merches`,
      merch
    ).then(res => {
        console.log(res)
    ...
    render() { 
        ...
        <div className="form-group">
                ...
                <select className="custom-select custom-select-lg" value={this.state.category} type="text" name="category" onChange={this.handleChange}>
